...
<link rel="stylesheet" type="text/css" href="style_mitarbeiter.css">
    <title>Mitarbeiter CSV Upload</title>
</head>
<body>
<?php include('menu.php'); ?>
<div class= "content">
    <div class="container">
    <h1>Mitarbeiter CSV Upload</h1>
                ...
                if ($file) {
                    ...
                    while (($row = fgetcsv($file, 1000, ',')) !== false) {
                        ...
                        if (count($row) == 5) {
                            ...
                            $sql = "INSERT INTO mitarbeiterinnen (mitarbeiterid, vorname, nachname, abteilung, benutzername)
                                    VALUES ('$mitarbeiterid', '$vorname', '$nachname', '$abteilung', '$benutzername')";
    ...
    <form action="upload_csv_mitarbeiter.php" method="post" enctype="multipart/form-data">
